...
// // ── NetworkBg now covers the FULL PAGE via position:fixed ──
// function NetworkBg() {
//   const canvasRef = useRef(null);
//   useEffect(() => {
//     const canvas = canvasRef.current;
...
//       {/* Fixed gradient glows — visible everywhere */}
...
//         {/* ═══════════ HERO ═══════════ */}
//         <section className="relative overflow-hidden min-h-screen flex items-center">
//           {/* Hero-only subtle gradient overlay */}
...
//                   /* Semi-transparent so the network animation shows through */
...
//           50% { border-color: transparent; }
//         }
//         /* Hide scrollbar on the page body to keep it clean */
//         body {
//           background: ${C.page};
//         }
//       `}</style>
