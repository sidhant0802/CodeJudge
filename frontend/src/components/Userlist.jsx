...
//   // Fixed wider columns so Submissions and Accepted don't merge
//   const gridCols = userRole === 'admin'
//     ? '150px 1fr 110px 120px 110px 90px 60px 75px 55px'
//     : '150px 1fr 110px 120px 110px';
...
//                   {[
//                     { label: 'Joined',   value: formatDate(user.DateTime), color: '#4a5568' },
